...
public class MainActivity extends AppCompatActivity {
    ...
    public void getChinaHoliday(View view) {
        ...
        OkHttpUtils
                ...
                //.id(100)
                .build()
                .execute(new ListHolidayCallback() {
                    @Override
                    public void onError(Call call, Exception e, int id) {
                    ...
                    @Override
                    public void onResponse(List<Holiday> response, int id) {
    ...
    public void getChinaHoliday2(View view) {
        ...
        OkHttpUtils
                ...
                //.id(100)
                .build()
                .execute(new GenericsCallback<News>(new JsonGenericsSerializator2() {
                }) {
                    @Override
                    public void onError(Call call, Exception e, int id) {
                        Log.e(TAG, "onError: " + e.getMessage());
                    ...
                    @Override
                    public void onResponse(News response, int id) {
